...
insert into departments values(1,'Computers');
insert into departments values(2,'Electronics')
insert into courses values('CSC505','Algorithms','FALL2015',1);  
insert into books values(200108613,'IntrotoAlgos','Cormen',4,2005,'CareerMonk',5,0,2,'CSC505',NULL);
